        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <a class="nav-link" href="marketing.php">Hire a Digital Marketing</a>
        ...
        <main class="container">
            <div class="p-4 p-md-5 mb-4 rounded text-bg-light">
                <div class="col-md-6 px-0">
                    <h1 class="display-4 fst-italic">Email Marketing in Nigeria</h1>
                    <p class="lead my-3">How to generate and nurture leads for your business.</p>
            ...
            <div class="row mb-2">
                <div class="col-md-6">
                    <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                        <div class="col p-4 d-flex flex-column position-static">
                            ...
                            <h3 class="mb-0">Local business to get grants from the Federal Government</h3>
                ...
                <div class="col-md-6">
                    <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                        <div class="col p-4 d-flex flex-column position-static">
                            <strong class="d-inline-block mb-2 text-success">Finance</strong>
                            <h3 class="mb-0">The falling crypto market</h3>
